...
namespace mmatrix
{
    ...
    constexpr double sqrt2 = 1.414213562373095;    // sqrt(2) and so on.
    ...
    std::complex<double> m11(double t, double qq, int J_max, std::vector<double> &phase_uncoupled,
                             std::vector<double> &phase_coupled)
    {
        ...
        for (int jtemp = 1; jtemp < J_max + 1; jtemp = jtemp + 1)
        {
    ...
    std::complex<double> m10(double t, double qq, int J_max, std::vector<double> &phase_uncoupled,
                             std::vector<double> &phase_coupled)
    {
    ...
    std::complex<double> mpm(double t, double qq, int J_max, std::vector<double> &phase_uncoupled,
                             std::vector<double> &phase_coupled)
    {
        std::complex<double> temp;
        // uncoupled channels
    ...
    std::complex<double> m01(double t, double qq, int J_max, std::vector<double> &phase_uncoupled,
                             std::vector<double> &phase_coupled)
    {
        std::complex<double> temp;
        // uncoupled channels
    ...
    std::complex<double> m00(double t, double qq, int J_max, std::vector<double> &phase_uncoupled,
                             std::vector<double> &phase_coupled)
    {
        std::complex<double> temp;
        // uncoupled channels
    ...
    std::complex<double> mss(double t, double qq, int J_max, std::vector<double> &phase_uncoupled,
                             std::vector<double> &phase_coupled)
    {
        std::complex<double> temp;
